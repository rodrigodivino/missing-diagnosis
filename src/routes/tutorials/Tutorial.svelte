...
<p> Os vídeos a seguir contém informações sobre a visualização. Sinta-se à vontade para pausar e retroceder os vídeos, ou assistir novamente caso desejar.</p>
